...
class Game:
    ...
    def __init__(self, game_window_width, game_window_height, score_to_win):
        ...
        pygame.init()
        self.font = pygame.font.Font('star_invaders/assets/font/Starjedi.ttf', 24)
        self.favicon = pygame.image.load('star_invaders/assets/images/favicon.png')
        self.score = 0
    ...
    def start_menu(self):
        ...
        # button images
        start_image = pygame.image.load('star_invaders/assets/images/buttonimages/start.png')
        exit_image = pygame.image.load('star_invaders/assets/images/buttonimages/exitbutton.png').convert_alpha()
    ...
    def start_game(self):
        ...
        # loads background
        background = pygame.image.load("star_invaders/assets/images/background.png")
